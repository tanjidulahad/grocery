  ...
  return (
    <div className="w-full  rounded  bg-white">
      ...
      <div className="my-4 px-2 md:mx-0 lg:mx-0 border-gray-200 w-full grid grid-cols-4">
        ...
        <div className=" w-[100px] h-[100px] md:w-[146px] md:h-[146px] rounded bg-gray-900 shrink-0 col-span-1">
        ...
        <div className='flex justify-between col-span-3'>
          <div className="ml-8 lg:ml-4 md:ml-0 flex flex-col justify-center">
