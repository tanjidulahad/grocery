              ...
              <div className=" h-10 my-6">
                ...
                <Link href='/account/wallet ' >
                  <div className="flex items-center justify-between">
                    ...
                    <p className={`font-semibold ${customerWallet?.customer_wallet_balance.length>=7 ? "text-sm":"text-base"} py-1 text-[#44ADF4] bg-[#44ADF440] mr-7 px-2 rounded-3xl`}><span className="text-[#44ADF4] mr-1">₹</span> {customerWallet?.customer_wallet_balance}</p>
                  </div>
                </Link>
              </div> :
              <div className=" cursor-pointer h-10 my-6">
