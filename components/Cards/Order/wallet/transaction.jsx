...
function transaction({ item, transaction = 'add' }) {
  console.log(item)
  return (
    <div className="w-full py-4 md:py-0  bg-white mb-[46px] md:mb-0">
                  ...
                  {items?.purchase_id === "" ?
                    ...
                    <>
                      {items.transaction_type == 'ORDER_REFUND' ?
                        <img className="w-[70px] h-[70px] max-h-[70px] max-w-[70px] lg:w-full lg:h-full lg:max-w-[90px] rounded object-cover opacity-80" src={'/img/refund.png'} alt="refund"/>
                        :
                        <img className="w-[70px] h-[70px] max-h-[70px] max-w-[70px] lg:w-full lg:h-full lg:max-w-[90px] rounded object-cover opacity-80" src={'/img/paid.png'} alt="paid"/>
                      }
                    </>
              ...
              {items.transaction_type == 'ORDER_REFUND' ?
                <div className='w-full mt-4'>
                  <div className='flex items-center'>
                    <p className="text-left font-bold text-xs lg:text-base traxt-dark ml-4 md:ml-0">Money Added</p>
                  ...
                  <p className="text-left text-sm  font-bold  text-[#48887B]  ml-4 md:ml-0 ">{moment.unix(items?.transaction_time).format("DD-MM-YY")}</p>
