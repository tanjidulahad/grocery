...
export default function* userSagas() {
    ...
    call(onRegisterWithPassword), call(onLoginWithPasswordStart), call(onForgotPasswordStart), call(onForgotPasswordOtpVerifyStart), call(onNewPasswordCreateStart), call(onUpdateUserDetailsStart), call(onGetCustomerWallet), call(onGetCountriesStart)
    ])
